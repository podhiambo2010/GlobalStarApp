...
class TenantPortalBackend:
    ...
    def calculate_tenant_arrears(self, current_day: int = None) -> pd.DataFrame:
        ...
        # Strictly include physical shops 1 to 22
        ...
        def calc_expected(row):
            ...
            if s_num == 21: return rate * 4
            elif s_num in [20, 22]: return rate * 5
            return rate * 12
        ...
        df_res['Telephone No.'] = df_res['Telephone No.'].astype(str).str.replace(' ', '').str.strip()
    ...
    def generate_etims_tax_invoice_pdf(self, tenant_name: str, shop_no: int, rate: float, paybill: str, paybill_acc: str, branch_name: str, bank_code: str, branch_code: str, swift_code: str, billing_month: str = "July 2026", base_filename: str = None, kra_pin: str = "P051548911H", etims_env: str = "Sandbox (Testing)"):
        ...
        if KRAeTIMSClient:
            ...
            etims_res = client.transmit_rent_invoice(tenant_name, tenant_pin, shop_no, rate, is_vat_applicable=False, billing_month=billing_month)
...
"""
    ...
    def send_whatsapp_message(self, recipient_phone: str, message_text: str, access_token: str, phone_number_id: str) -> tuple:
        """Sends an automated WhatsApp notification via Meta's official Cloud API."""
        ...
        # Clean phone number (remove spaces, plus signs, or dashes)
